...
PROVIDER_INFO = {
    ...
    "runway": {
        ...
        "description": "AI-powered video generation with Gen-3 Alpha",
    },
    "heygen": {
        "provider": "heygen",
        "name": "HeyGen",
        ...
        "auth_method": "api_key",
        "required": False,
        "docs_url": "https://docs.heygen.com/reference/overview",
    ...
    "veo": {
        ...
        "auth_method": "api_key",
        "required": False,
        "docs_url": "https://cloud.google.com/vertex-ai/generative-ai/docs/video/overview",
    ...
    "luma": {
        ...
        "description": "AI video generation with Dream Machine",
    },
    "imagineart": {
        "provider": "imagineart",
        "name": "ImagineArt",
        ...
        "auth_method": "api_key",
        "required": False,
        "docs_url": "https://www.imagine.art/",
    ...
    "hailuo": {
        ...
        "auth_method": "api_key",
        "required": False,
        "docs_url": "https://hailuoai.video/",
        "description": "AI video generation from MiniMax",
    },
    "ltx": {
        "provider": "ltx",
        "name": "LTX Video",
    ...
    "creatomate": {
        ...
        "auth_method": "api_key",
        "required": False,
        "docs_url": "https://creatomate.com/docs/api",
        "description": "Video automation and rendering API",
    },
    "shotstack": {
        "provider": "shotstack",
        "name": "Shotstack",
        ...
        "auth_method": "api_key",
        "required": False,
        "docs_url": "https://shotstack.io/docs/api/",
    ...
    "editframe": {
        ...
        "auth_method": "api_key",
        "required": False,
        "docs_url": "https://docs.editframe.com/",
        "description": "Programmatic video editing API",
    },
    "ffmpeg": {
        "provider": "ffmpeg",
        "name": "FFmpeg",
